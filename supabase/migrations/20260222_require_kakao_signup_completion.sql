-- Add signup completion gate for Kakao OAuth users
alter table public.profiles
  add column if not exists signup_completed boolean not null default true;

-- Recreate handle_new_user to initialize Kakao users as incomplete
...
begin
  ...
  v_signup_completed := case when v_provider = 'kakao' then false else true end;
