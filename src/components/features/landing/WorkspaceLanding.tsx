  ...
  korean: {
    ...
    features: [
      ...
      },
      {
        icon: PackageSearch,
        title: '상품 확인',
        description: '문제마켓 안에서 필요한 자료를 살펴보고 현재 제공 중인 국어 콘텐츠를 빠르게 비교할 수 있습니다.',
      },
      {
        icon: LibraryBig,
        title: '국어문제마켓 관리',
        description: '라이브러리 안에서 구매한 국어문제마켓 자료를 다시 확인하고 관리 흐름으로 이어갈 수 있습니다.',
      },
    ],
    steps: [
      {
        icon: ShoppingBag,
        title: '문제마켓 탐색',
        description: '국어문제마켓에서 필요한 자료를 먼저 둘러봅니다.',
      },
      {
        icon: PackageSearch,
        title: '상품 확인',
        description: '관심 있는 자료를 확인하고 필요한 항목을 선택합니다.',
      },
      {
        icon: LibraryBig,
        title: '국어문제마켓 관리',
        description: '라이브러리에서 구매한 국어문제마켓 자료를 다시 관리합니다.',
      },
    ],
    theme: {
