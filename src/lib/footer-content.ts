...
## 2. 환불 가능 기준
회원은 결제일로부터 1년 이내에 미사용 크레딧 또는 이용하지 않은 디지털 자료에 대해 환불을 요청할 수 있습니다. 구매한 크레딧의 사용 및 취소/환불 신청 가능 기간은 결제일로부터 1년이며, 기간이 경과하면 미사용 크레딧의 사용 또는 환불이 제한될 수 있습니다. 다음의 경우 환불 또는 크레딧 복구를 신청할 수 있습니다.
...
- 충전된 크레딧을 회원 간 양도·이전, 현금 교환 또는 명의 변경 방식으로 처리해 달라고 요청하는 경우
